...
class VTKRENDERINGVOLUME_EXPORT vqFixedPointVolumeRayCastAIPHelper : public vtkFixedPointVolumeRayCastHelper
{
public:
...
protected:
    ...
    ~vqFixedPointVolumeRayCastAIPHelper() VTK_OVERRIDE;
private:
    vqFixedPointVolumeRayCastAIPHelper(const vqFixedPointVolumeRayCastAIPHelper&) VTK_DELETE_FUNCTION;
    void operator=(const vqFixedPointVolumeRayCastAIPHelper&) VTK_DELETE_FUNCTION;
};
...
namespace vqRender {
    ...
    public:
        ...
        vector cross(const vector& v) const {
            return vector((m_data[1] * v[2] - m_data[2] * v[1]), (m_data[2] * v[0] - m_data[0] * v[2]), (m_data[0] * v[1] - m_data[1] * v[0]));
        }
...
class VTKRENDERINGVOLUME_EXPORT vqFixedPointVolumeRayCastISOHelper : public vtkFixedPointVolumeRayCastHelper
{
public:
...
protected:
    ...
    ~vqFixedPointVolumeRayCastISOHelper() VTK_OVERRIDE;
private:
    vqFixedPointVolumeRayCastISOHelper(const vqFixedPointVolumeRayCastISOHelper&) VTK_DELETE_FUNCTION;
    void operator=(const vqFixedPointVolumeRayCastISOHelper&) VTK_DELETE_FUNCTION;
};
